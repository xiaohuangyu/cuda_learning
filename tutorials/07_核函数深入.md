...
graph TB
    ...
    style IDX1 fill:#E3F2FD
    style IDX2 fill:#E8F5E9
    style IDX3 fill:#FFF3E0
```
...
[第八章：性能分析入门](./08_性能分析入门.md) - 学会使用工具分析 CUDA 程序性能，找出瓶颈
